...
$mod_strings = array(
    ...
    'LBL_CASE_INFORMATION' => 'Información  del caso', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LBL_CASE_UPDATE_FORM' => 'Actualizar pantalla de adjuntos', //Form for attachments on case updates
);
