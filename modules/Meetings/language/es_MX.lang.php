...
$mod_strings = array(
    ...
    'LBL_MEETING_INFORMATION' => 'Información de la reunión', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
